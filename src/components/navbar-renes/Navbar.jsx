        ...
        <div className="navBarContainer">
            ...
            <section className="nav-bar-right">
                <div className="navbar-links">
                    ...
                    <Popup trigger={<button className="account-button"><img className="acc icon" src={accountBtn} alt="account" /></button>} >
                        <div className="popup">
                            <ul className="ULpopup">
                                ...
                                <li className="listE"> <Link to="/user" className='text-link'><div> <span className="ZC1wz">Profil</span> </div></Link></li>
                            </ul>
                        </div>
                    </Popup>
                    ...
                    <button className='BTNoturum' onClick={()=>navigate('/login')} >Oturum Aç</button>
